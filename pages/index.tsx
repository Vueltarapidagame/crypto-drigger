...
const Home: NextPage = () => {
    ...
    return (
      ...
      backgroundRepeat="no-repeat">
        <Flex direction={"column"} h={"100vh"} justifyContent={"center"} alignItems={"center"}>
          <Heading my={"40px"} color="white">Welcom to Crypto Diggers</Heading>
          <ConnectWallet />
        </Flex>
      </Container>
    );
  ...
  return (
    <Container maxW={"1200px"}
      ...
      <Card p={5} backgroundColor="transparent">
      <Heading mb={"10px"} color="white"> Miners:</Heading>
          <SimpleGrid columns={2} spacing={10}>
            <Box>
            ...
            <Box>
              <Text fontSize={"small"} fontWeight={"bold"} color="white">$Balance:</Text>
                {rewardBalance && (
        ...
        <Card p={5} backgroundColor="transparent">
        <Heading mb={"10px"} color="white">Mining Machines:</Heading>
      ...
      <Card p={5} backgroundColor="transparent">
      <Heading textAlign="center" mb={"10px"} color="white">Mining Machines Working:</Heading>
      <Card p={5} backgroundColor="transparent">
